## [Planes and Nodes](https://courses.devopsdirective.com/kubernetes-beginner-to-pro/lessons/02-technology-overview/01-main#planes-and-nodes)

![[Pasted image 20250622123526.png]]
...
## [Kubernetes System Components](https://courses.devopsdirective.com/kubernetes-beginner-to-pro/lessons/02-technology-overview/01-main#kubernetes-system-components)

![[Pasted image 20250622123549.png]]
...
Kubernetes interfaces
 ...
 - Container Runtime Interface CRI
		executes and run containers - from Kubernetes 1.0 containerd and cri-o (no docker)
 - Container Network Interface CNI
		network connectivity and removing allocated resources during container deletion
 - Container Storage Interface CSI
		provides durable, persistent storage to running workload in Kubernetes


Kubernetes project in action:
